                                        ...
                                        <div className={`flex flex-col gap-1 ${message.isUser ? 'items-end' : 'items-start'}`}>
                                            <div className={`rounded-2xl px-3 py-2 text-[13.6px] flex flex-col ${message.isUser ? 'bg-[#1b82ae] text-white' : 'bg-white/10 text-white border border-white/20'}`}>
                                                ...
                                                {!message.isUser && message.id !== '1' && (
                                                    <a href="https://wa.me/01557777587" target="_blank" rel="noopener noreferrer" className="mt-3 flex items-center justify-center gap-2 text-xs bg-[#1b82ae]/30 hover:bg-[#1b82ae]/50 text-white font-semibold py-1.5 px-3 rounded-lg transition-all border border-[#1b82ae]/50">
